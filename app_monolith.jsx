...
const i18n = {
  en: {
    ...
    faqs: [
      ...
      { q: "Behind this?", a: "This platform is created by only me, and i don't use it for commercial purpose. It has it own flaws and I know so be gentle." },
      ...
      { q: "Can I retake the test?", a: "Yes. And we recomment it. You can take it as a learning platform too, as the real answers will be provided so you can see your own mistakes and learn from that, not like traditional diagnostic on the internet." },
    ],
    ...
    <div className="app">
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .diagnosis-trigger-wrap {
          margin-bottom: 24px;
          animation: slideUp 0.6s ease 0.3s both;
        }
        .diagnosis-trigger-btn {
          display: flex;
          align-items: center;
          gap: 12px;
          width: 100%;
          background: var(--white);
          border: 2px solid var(--teal-wash-2);
          border-radius: var(--radius);
          padding: 18px 20px;
          cursor: pointer;
          font-family: var(--font-sans);
        ...
        .diagnosis-trigger-btn:hover {
          border-color: var(--teal);
          background: var(--teal-wash);
          transform: translateY(-1px);
          box-shadow: var(--shadow-md);
        }
        .dtb-icon { font-size: 18px; }
        .dtb-arrow { margin-left: auto; color: var(--teal); font-size: 18px; }
        .dtb-sub {
          font-size: 12px;
          color: var(--slate);
          margin-top: 8px;
        ...
        .diagnosis-modal-header {
          ...
          z-index: 10;
          background: var(--white);
          border-bottom: 1px solid var(--teal-wash-2);
          padding: 16px 20px;
          display: flex;
          align-items: center;
          gap: 16px;
        ...
        .diagnosis-back-btn:hover { background: var(--teal-wash); }
